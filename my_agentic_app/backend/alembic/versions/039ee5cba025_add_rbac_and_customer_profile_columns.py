"""Add RBAC and Customer profile columns

Revision ID: 039ee5cba025
Revises: 85fc9959578f
Create Date: 2026-06-17 20:50:22.424739
...
revision: str = '039ee5cba025'
down_revision: Union[str, Sequence[str], None] = '85fc9959578f'
...
def upgrade() -> None:
    ...
    # ❌ ลบคำสั่ง op.drop_table และ op.drop_index ของ checkpoint ทิ้งทั้งหมด
    # เพื่อไม่ให้ Alembic ไปยุ่งกับตารางของ LangGraph
    pass 
...
def downgrade() -> None:
    ...
    # ❌ ลบคำสั่ง op.create_table ของ checkpoint ทิ้งทั้งหมดเช่นกัน
    pass
